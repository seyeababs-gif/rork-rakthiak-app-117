...
import { getResponsiveValue, isDesktop } from '@/constants/responsive';
...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    if (!deliveryAddress.trim()) {
      toast.showError('Veuillez entrer votre adresse de livraison');
      return;
    }
...
const styles = StyleSheet.create({
  ...
  header: {
    alignItems: 'center',
    marginBottom: getResponsiveValue({ mobile: 40, tablet: 32, desktop: 24 }),
  },
  logo: {
  ...
  form: {
    gap: getResponsiveValue({ mobile: 20, tablet: 16, desktop: 14 }),
  },
  inputContainer: {
    gap: 8,
  },
  ...
  hint: {
    fontSize: getResponsiveValue({ mobile: 12, tablet: 11, desktop: 11 }),
    color: '#999',
    lineHeight: getResponsiveValue({ mobile: 18, tablet: 16, desktop: 16 }),
  },
  button: {
    flexDirection: 'row',
    alignItems: 'center',
